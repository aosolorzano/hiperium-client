 ...
 * 
 */
package com.hiperium.commons.client.registry.path;

/**
 * @author Andres Solorzano
 *
 */
public final class IdentityRegistryPath {
	...
	/** The property BASE_PATH with value /services/identity used in ZOOKEEPER. */
	public static final String BASE_PATH = "/services/identity";
